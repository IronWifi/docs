...
You are responsible for ensuring the functionality of your computer or mobile device and network connections that connect you to the Service, including, but not limited to, “browser” software. We assume no responsibility for the reliability or performance of your internet provider or any connections or devices as described in this section.
...
We offer the following Subscription plans of the Service. Overview of available subscription plans and their features can be found at www.ironwifi.com/pricing.

__Free Subscription__ is without any billing; however, the Service’s features are limited. Particularly the number of users and access points is minimal.
...
At the end of each Billing Cycle, your Subscription will automatically renew under the same conditions unless you cancel it or IronWifi, LLC cancels it. You may cancel your Subscription renewal in your billing profile by changing to the Free Subscription or by deleting your payment method details.

Valid payment method – is required to process the payment for your Subscription. You shall provide IronWifi, LLC with accurate billing information and a valid payment method information. By submitting such payment information, you automatically authorize IronWifi, LLC to charge you the Subscription fees based on selected Billing Cycle, or to send you an invoice with wire transfer instructions.

Should automatic billing fail to occur for any reason, we will notify you by email, and you must provide a new payment method in case you wish to continue to use the Service.

***Refunds***

You can request a full refund for any reason within 15 days of completing your first payment for the Service. It’s not possible to refund the payment if the refund request is made more than 15 days after the first-ever payment was made in your account. This refund only applies to your first-ever payment, unless otherwise stipulated in these Terms or DPA.
...
By using Service, various Personal data may be collected by you and processed by us on your behalf, depending on how you use the Service. As our Service is also operated within the European Union, the Directive and other Personal data protection provisions of the EU Member states are applicable.

It is solely your obligation to comply with any applicable law when using the Service and to collect any Personal data by the Service. IronWifi, LLC disclaims any liability as described in paragraph 10.
...
In case you allow (accidentally or deliberately) any Personal Data to be processed by the Service when using a free Subscription, you must immediately prevent any further Personal data processing and inform us without delay via email at support@ironwifi.com.
...
The DPA is also terminated once you cancel your paid Subscription or once it expires for any reason. The cancellation and/or expiration of your paid subscription does not represent the termination of your account.
...
If you do not agree to the new terms, please stop using the Service or contact us at support@ironwifi.com.
